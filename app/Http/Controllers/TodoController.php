...
class TodoController extends Controller
{
    ...
    public function index()
    {
        ...
        //ngambil data dari setiap user berbeda
        $todos = Todo::where([
    ...
    {
        // $id pada parameter mengambil data dari patch dinamis
        // dari data yang memiliki value column id sama dengan data id yang dikirim ke route, maka update baris data tersebut
        Todo::where('id', $id)->update([
            'status' => 1,
            'done_time' => Carbon::now(),
        ]);

        return redirect()->route('todo.complated')->with('done' ,   'Todo sudah berhasil yeyey');
    ...
    public function destroy($id)
    {
        ...
        //cari data yang isian column id nya sama dengan $id yang dikirim ke patch  dinamis
        //kalau ada, ambil terus hapus datanya
        Todo::where('id', '=', $id)->delete();
        //kalo berhasil, bakal dibalikin ke halaman list todo dengan pemberitahuan
