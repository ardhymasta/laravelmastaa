...
@section('content')
<div class="container d-flex justify-content-center align-items-center mt-5" style="padding-top: 40px;">
    <form method="POST" action="{{route('login.auth')}}" class="card py-4 px-4">
        ...
        <div class=" mt-5 d-flex justify-content-between align-items-center">
            <span><a href="{{route('register')}}" style="text-decoration: none; color: rgb(255, 88, 141)">Tidak punya akun?</a></span>
